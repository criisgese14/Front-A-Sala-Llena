...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <p>
        El presente Política de Privacidad establece los términos en que A Sala
        Llena usa y protege la información que es proporcionada por sus usuarios
      ...
      <p>
        A Sala Llena está altamente comprometido para cumplir con el compromiso
